...
Requires:       ros-iron-kitti-metrics-eval
Requires:       ros-iron-mola-bridge-ros2
Requires:       ros-iron-mola-demos
Requires:       ros-iron-mola-imu-preintegration
Requires:       ros-iron-mola-input-euroc-dataset
...
Requires:       ros-iron-mola-metric-maps
Requires:       ros-iron-mola-navstate-fg
Requires:       ros-iron-mola-navstate-fuse
Requires:       ros-iron-mola-pose-list
Requires:       ros-iron-mola-relocalization
Requires:       ros-iron-mola-traj-tools
Requires:       ros-iron-mola-viz
Requires:       ros-iron-mola-yaml
Requires:       ros-iron-ros-workspace
BuildRequires:  ros-iron-ament-cmake
BuildRequires:  ros-iron-kitti-metrics-eval
BuildRequires:  ros-iron-mola-bridge-ros2
BuildRequires:  ros-iron-mola-demos
BuildRequires:  ros-iron-mola-imu-preintegration
BuildRequires:  ros-iron-mola-input-euroc-dataset
...
BuildRequires:  ros-iron-mola-launcher
BuildRequires:  ros-iron-mola-metric-maps
BuildRequires:  ros-iron-mola-navstate-fg
BuildRequires:  ros-iron-mola-navstate-fuse
BuildRequires:  ros-iron-mola-pose-list
BuildRequires:  ros-iron-mola-relocalization
BuildRequires:  ros-iron-mola-traj-tools
BuildRequires:  ros-iron-mola-viz
BuildRequires:  ros-iron-mola-yaml
